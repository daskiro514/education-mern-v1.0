...
const CustomerMessages = ({ clientID, addNewMessage, getMessages, deleteMessage, messages, getAdmin, admin, messagesRead }) => {
  React.useEffect(() => {
...
export default connect(mapStateToProps, { addNewMessage, getMessages, deleteMessage, getAdmin, messagesRead })(CustomerMessages)