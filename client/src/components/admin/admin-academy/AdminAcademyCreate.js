...
const AdminAcademyCreate = ({ match, addNewCourse, setAlert }) => {
...
export default connect(mapStateToProps, { addNewCourse, setAlert })(AdminAcademyCreate)